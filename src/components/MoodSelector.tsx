...
const MoodSelector: React.FC<MoodSelectorProps> = ({ selectedMood, setSelectedMood }) => {
  ...
  // Handle Find Music button
  function handleFindMusic() {
    if (typedMood.trim() !== "") {
      setSelectedMood(typedMood.trim());
      setShowPlayer(true);
      setTypedMood("");
    }
  }
  ...
  // Handle card click
  function handleCardClick(moodId: string) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-blue-200 max-w-2xl mx-auto">
            Describe your mood in words, or pick one of the cards below
          </p>
        </motion.div>
        ...
        >
          <div className="relative w-full max-w-2xl mx-auto">
            <input
              ...
              className="w-full p-6 pr-40 text-lg bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl 
